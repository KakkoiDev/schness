// `initSettings` lived here and wired up a `#settings-dialog` that no page has
// had since communication settings moved into the match rail. It was the only
// DOM this module touched, which is why the layer table calls `settings` pure.
